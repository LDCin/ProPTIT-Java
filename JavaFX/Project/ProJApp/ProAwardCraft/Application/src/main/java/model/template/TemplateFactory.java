...
public class TemplateFactory {
    ...
    public static List<Template> getTemplates() {
        ...
        Template giayKhen = new Template("Giấy khen", "#FF0000", "#FFF9E6", "images/templates/giay_khen_preview.png");
        ...
        Template giayChungNhan = new Template("Giấy chứng nhận", "#005BB5", "#E6F0FA", "images/templates/giay_chung_nhan_preview.png");
        ...
        Template bangKhen = new Template("Bằng khen", "#FFD700", "#FFFFFF", "images/templates/bang_khen_preview.png");
        ...
        Template chungNhanThanhTich = new Template("Chứng nhận thành tích", "#000000", "#E6FFE6", "images/templates/chung_nhan_thanh_tich_preview.png");
        ...
        Template giayVinhDanh = new Template("Giấy vinh danh", "#800080", "#F5E6FF", "images/templates/giay_vinh_danh_preview.png");
